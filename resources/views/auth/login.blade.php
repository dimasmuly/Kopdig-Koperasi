                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Kopdig.</p>
                                </div>
                                <div class="p-2 mt-4">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            </script> Koperasi Digital. Crafted with <i
                                class="mdi mdi-heart text-danger"></i> by Politeknik Negeri Jember</p>
                        </div>
                    </div>
                </div>
            </div>
